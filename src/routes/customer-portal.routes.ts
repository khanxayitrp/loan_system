 ...
 *         description: Server error
 */
router.get('/application/:application_id', checkLoanOwnership, getLoanbyCusIDandLoanID);
 ...
 *         description: Server error
 */
router.get('/contract/:application_id', checkLoanOwnership, LoanContractController.getLoanContractFromCustomer); // เพิ่ม Route นี้สำหรับให้ลูกค้าเห็นสัญญาของตัวเอง
 ...
 *         description: Server error
 */
router.get('/contract/:application_id/pdf/:contractId', checkLoanOwnership, getCustomerLoanContractPDF); // เพิ่ม Route นี้สำหรับให้ลูกค้าเห็นสัญญาของตัวเอง
 ...
 *         description: Server error
 */
router.put('/application/:application_id/cancelled', checkLoanOwnership, cancelLoanApplicationbyCustomer); // เพิ่ม Route นี้สำหรับให้ลูกค้า ยกเลิกบิลของตัวเอง
