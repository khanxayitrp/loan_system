...
export interface loan_change_requestsAttributes {
  ...
  change_type: 'FULL_OVERRIDE' | 'CHANGE_PARTNER' | 'CHANGE_PRODUCT' | 'CANCEL_ONLY' | 'CANCEL_AND_RECREATE' | 'CHANGE_PAYMENT_DATE' | 'CHANGE_CUSTOMER_INFO' | 'CHANGE_WORK_INFO' | 'CHANGE_GUARANTOR_INFO';
  old_data: object;
  new_data: object;
  reason: string;
...
export class loan_change_requests extends Model<loan_change_requestsAttributes, loan_change_requestsCreationAttributes> implements loan_change_requestsAttributes {
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof loan_change_requests {
    ...
    change_type: {
      type: DataTypes.ENUM('FULL_OVERRIDE','CHANGE_PARTNER','CHANGE_PRODUCT','CANCEL_ONLY','CANCEL_AND_RECREATE','CHANGE_PAYMENT_DATE', 'CHANGE_CUSTOMER_INFO','CHANGE_WORK_INFO','CHANGE_GUARANTOR_INFO'),
      allowNull: false,
