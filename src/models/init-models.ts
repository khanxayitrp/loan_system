...
import { loan_change_requests as _loan_change_requests } from "./loan_change_requests";
import type { loan_change_requestsAttributes, loan_change_requestsCreationAttributes } from "./loan_change_requests";
...
export {
  ...
  _loan_change_requests as loan_change_requests,
...
export type {
  ...
  loan_change_requestsAttributes,
  loan_change_requestsCreationAttributes,
...
export function initModels(sequelize: Sequelize) {
  ...
  const loan_change_requests = _loan_change_requests.initModel(sequelize);
  ...
  loan_change_requests.belongsTo(loan_applications, { as: "application", foreignKey: "application_id"});
  loan_applications.hasMany(loan_change_requests, { as: "loan_change_requests", foreignKey: "application_id"});
  loan_change_requests.belongsTo(loan_applications, { as: "replacement_loan", foreignKey: "replacement_loan_id"});
  loan_applications.hasMany(loan_change_requests, { as: "replacement_loan_loan_change_requests", foreignKey: "replacement_loan_id"});
