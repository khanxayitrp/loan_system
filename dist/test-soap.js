...
exports.exampleGenerateTransactionId = exampleGenerateTransactionId;
exports.exampleEncryptKey = exampleEncryptKey;
exports.exampleValidateSMSParams = exampleValidateSMSParams;
exports.exampleParseResultCode = exampleParseResultCode;
exports.exampleFormatPhoneNumber = exampleFormatPhoneNumber;
exports.exampleCompleteSMSFlow = exampleCompleteSMSFlow;
exports.runAllExamples = runAllExamples;
const ltc_encrypt_1 = require("./utils/ltc-encrypt");
// Example 1: Generate Transaction ID
function exampleGenerateTransactionId() {
    console.log('\n=== Example: Generate Transaction ID ===');
    const transId1 = (0, ltc_encrypt_1.generateTransactionId)(); // Default prefix "OTP"
    const transId2 = (0, ltc_encrypt_1.generateTransactionId)('PAY'); // Custom prefix
    const transId3 = (0, ltc_encrypt_1.generateTransactionId)('VER'); // Another custom prefix
...
async function exampleEncryptKey() {
    console.log('\n=== Example: Encrypt Key ===');
    const userId = 'TEST';
    const transactionId = (0, ltc_encrypt_1.generateTransactionId)();
    ...
    const encryptedKey1 = await (0, ltc_encrypt_1.generateSolution1Key)(userId, transactionId, privateKey);
    console.log('\nSolution 1 (userid + trans_id):');
    ...
    const encryptedKey2 = await (0, ltc_encrypt_1.generateSolution2Key)(userId, transactionId, msisdn, privateKey);
    console.log('\nSolution 2 (userid + trans_id + msisdn):');
...
function exampleValidateSMSParams() {
    ...
    console.log('\n1. Valid parameters:');
    const result1 = (0, ltc_encrypt_1.validateSMSParams)(validParams);
    console.log('  Result:', result1);
    // Invalid: Short private key
    console.log('\n2. Invalid: Private key too short');
    const result2 = (0, ltc_encrypt_1.validateSMSParams)({
        ...validParams,
        privateKey: 'short',
    });
    ...
    const result3 = (0, ltc_encrypt_1.validateSMSParams)({
        ...validParams,
    ...
    const result4 = (0, ltc_encrypt_1.validateSMSParams)({
        ...validParams,
...
function exampleFormatPhoneNumber() {
    ...
    phoneNumbers.forEach(phone => {
        const formatted = (0, ltc_encrypt_1.formatPhoneNumberForAPI)(phone);
        console.log(`Input:  "${phone}"`);
        console.log(`Output: "${formatted}"\n`);
    });
}
// Example 6: Complete SMS Request Flow
function exampleCompleteSMSFlow() {
    ...
    const msisdn = (0, ltc_encrypt_1.formatPhoneNumberForAPI)(phoneNumber);
    console.log('\nStep 2: Format phone number');
    ...
    const transactionId = (0, ltc_encrypt_1.generateTransactionId)('OTP');
    console.log('\nStep 4: Generate transaction ID');
    console.log('  Transaction ID:', transactionId);
    // Step 5: Encrypt key (both solutions)
    console.log('\nStep 5: Encrypt key');
    const encryptedKey1 = (0, ltc_encrypt_1.generateSolution1Key)(userId, transactionId, privateKey);
    console.log('\n  Solution 1 (userid + trans_id):');
    console.log('    Data to encrypt:', userId + transactionId);
    console.log('    Encrypted key:', encryptedKey1);
    const encryptedKey2 = (0, ltc_encrypt_1.generateSolution2Key)(userId, transactionId, msisdn, privateKey);
    console.log('\n  Solution 2 (userid + trans_id + msisdn):');
