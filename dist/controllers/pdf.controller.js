...
exports.generateDeliveryReceiptPDF = exports.generateRepaymentSchedulePDF = exports.generateLoanContractPDF = exports.generateLoanPDF = void 0;
...
const generateLoanPDF = async (req, res) => {
    ...
    try {
        ...
        console.log('✅ Font exists:', fs_1.default.existsSync(fontPath));
